 ...
 * Desc: 下拉刷新
 */
public class ZSwipeRefreshLayout extends ViewGroup implements AbsListView.OnScrollListener {
    private static final String TAG = ZSwipeRefreshLayout.class.getSimpleName();
    ...
    private View mTarget; //需要实现下拉刷新的view
    ...
    public ZSwipeRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        addView(mFooterView);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //mHanderView.measure(MeasureSpec.makeMeasureSpec(get));
    }
    ...
    private void ensureTarget() {
        if (mTarget == null) {
            for (int i = 0; i < getChildCount(); i++) {
                ...
                if (!child.equals(mFooterView) && !child.equals(mHanderView)) {
                    mTarget = child;
                    break;
                }
            }
