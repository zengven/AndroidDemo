...
package pub.ven.androiddemo.ui;
...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                Log.i(TAG, "onInterceptTouchEvent: mTouchSlop :"+mTouchSlop+"   yDiff: "+yDiff);
    ...
    public void requestDisallowInterceptTouchEvent(boolean b) {
        ...
        if ((android.os.Build.VERSION.SDK_INT < 21 && mTarget instanceof AbsListView)
            ...
            Log.i(TAG, "requestDisallowInterceptTouchEvent: ----start  "+ViewCompat.isNestedScrollingEnabled(mTarget));
            // Nope.
        } else {
    ...
    public boolean onStartNestedScroll(View child, View target, int nestedScrollAxes) {
        Log.i(TAG, "onStartNestedScroll: -------start");
    ...
    public void onNestedScrollAccepted(View child, View target, int axes) {
        Log.i(TAG, "onNestedScrollAccepted: -------start");
    ...
    public void onNestedPreScroll(View target, int dx, int dy, int[] consumed) {
        Log.i(TAG, "onNestedPreScroll: -------start");
    ...
    public int getNestedScrollAxes() {
        Log.i(TAG, "getNestedScrollAxes: -------start");
        return mNestedScrollingParentHelper.getNestedScrollAxes();
    }

    @Override
    public void onStopNestedScroll(View target) {
        Log.i(TAG, "onStopNestedScroll: -------start");
    ...
    public void onNestedScroll(final View target, final int dxConsumed, final int dyConsumed,
        ...
        Log.i(TAG, "onNestedScroll: -------start");
    ...
    public void setNestedScrollingEnabled(boolean enabled) {
        Log.i(TAG, "setNestedScrollingEnabled: -------start");
        mNestedScrollingChildHelper.setNestedScrollingEnabled(enabled);
    }

    @Override
    public boolean isNestedScrollingEnabled() {
        Log.i(TAG, "isNestedScrollingEnabled: -------start");
    ...
    public void stopNestedScroll() {
        Log.i(TAG, "stopNestedScroll: -------start");
        mNestedScrollingChildHelper.stopNestedScroll();
    }

    @Override
    public boolean hasNestedScrollingParent() {
        Log.i(TAG, "hasNestedScrollingParent: -------start");
    ...
    public boolean dispatchNestedScroll(int dxConsumed, int dyConsumed, int dxUnconsumed,
        ...
        Log.i(TAG, "dispatchNestedScroll: -------start");
    ...
    public boolean dispatchNestedPreScroll(int dx, int dy, int[] consumed, int[] offsetInWindow) {
        Log.i(TAG, "dispatchNestedPreScroll: -------start");
    ...
    public boolean onNestedPreFling(View target, float velocityX,
            float velocityY) {
        Log.i(TAG, "onNestedPreFling: -------start");
    ...
    public boolean onNestedFling(View target, float velocityX, float velocityY,
            boolean consumed) {
        Log.i(TAG, "onNestedFling: -------start");
        return dispatchNestedFling(velocityX, velocityY, consumed);
    }

    @Override
    public boolean dispatchNestedFling(float velocityX, float velocityY, boolean consumed) {
        Log.i(TAG, "dispatchNestedFling: -------start");
        return mNestedScrollingChildHelper.dispatchNestedFling(velocityX, velocityY, consumed);
    }

    @Override
    public boolean dispatchNestedPreFling(float velocityX, float velocityY) {
        Log.i(TAG, "dispatchNestedPreFling: -------start");
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                Log.i(TAG, "onTouchEvent: overscrollTop:"+overscrollTop);
                if (mIsBeingDragged) {
                    if (overscrollTop > 0) {
